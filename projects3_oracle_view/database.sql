CREATE TABLE "MI181_PCRAGSAC"."BILL" 
 ...
 NOCOMPRESS LOGGING
  ...
  CREATE TABLE "MI181_PCRAGSAC"."CHECK_IN_SLIP" 
 ...
 NOCOMPRESS LOGGING
  ...
  CREATE TABLE "MI181_PCRAGSAC"."CUSTOMER" 
   (	"ID" NUMBER(*,0) NOT NULL ENABLE, 
 ...
 NOCOMPRESS LOGGING
  ...
  CREATE TABLE "MI181_PCRAGSAC"."EMPLOYEE" 
   (	"ID" NUMBER(*,0) NOT NULL ENABLE, 
 ...
 NOCOMPRESS LOGGING
  ...
  CREATE TABLE "MI181_PCRAGSAC"."HOTEL" 
   (	"ID" NUMBER(*,0) NOT NULL ENABLE, 
 ...
 NOCOMPRESS LOGGING
  ...
  CREATE TABLE "MI181_PCRAGSAC"."KEY" 
   (	"ID" NUMBER(*,0) NOT NULL ENABLE, 
 ...
 NOCOMPRESS LOGGING
  ...
  CREATE TABLE "MI181_PCRAGSAC"."ROOM" 
   (	"ID" NUMBER(*,0) NOT NULL ENABLE, 
